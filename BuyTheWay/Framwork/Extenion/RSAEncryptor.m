...
//  RSAPublicKey
//
//  Created by 李丝思 on 2018/5/6.
//  Copyright © 2018年 yangtu222. All rights reserved.
//
...
-(NSString*) rsaDecryptString:(NSString*)string {
    NSData* data = [NSData dataWithBase64EncodedString:string];  //[NSData dataFromBase64String: string];
